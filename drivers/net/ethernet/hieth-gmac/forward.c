...
union fwd_usr_config {
	...
	struct {
		...
		unsigned int uc_tbl_miss_to_cpu		: 1;/* same bit for uc_to_cpu */
		unsigned int uc_tbl_miss_to_other	: 1;/* same bit for uc_to_other */
...
#define uc_to_other	uc_tbl_miss_to_other
		...
		unsigned int mc_tbl_miss_to_cpu		: 1;/* same bit for mc_to_cpu */
		unsigned int mc_tbl_miss_to_other	: 1;/* same bit for mc_to_other */
