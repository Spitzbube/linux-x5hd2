...
enum ion_heap_ids {
	...
	ION_SYSTEM_CONFIG_HEAP_ID = 5,
	ION_CARVEOUT_HEAP_ID	  = 6,
	ION_CHUNK_HEAP_ID	      = 7,
	ION_HIS_ID_JPEG		      = 10,
	ION_HIS_ID_VDEC		      = 11,
	ION_HIS_ID_FB		      = 12,
	ION_HIS_ID_GPU		      = 13,
	ION_HIS_ID_COMMON	      = 14,
	ION_HIS_ID_DDR		      = 15,
	ION_HIS_ID_INVALID	      = 30
...
/**
 * hisi heap name definations
 */
#define ION_HIS_NAME_JPEG			"jpeg"
#define ION_HIS_NAME_VDEC			"vdec"
#define ION_HIS_NAME_FB				"fb"
#define ION_HIS_NAME_GPU			"gpu"
#define ION_HIS_NAME_COMMON			"common"
#define ION_HIS_NAME_DDR			"ddr"
...
/**
 * struct ion_phys_data - metadata passed to/from the kernel to get the physic address
 * @handle:    a handle
 * @len:        buffer len
